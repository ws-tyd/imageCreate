...
public class PosterUtil {
     ...
     * @Param [bufferedImage, words, wordsFont, fontSize, wordsX, wordsY, wordsWidth, wordsHeight]
     **/
    public static void drawWordsTheme(BufferedImage bufferedImage, String words, Boolean isAddFontSpace, String wordsFont, int fontSize, int wordsX,
                                 int wordsY, int wordsWidth, int wordsHeight) {
        Graphics2D g2d = bufferedImage.createGraphics();
        // 抗锯齿 添加文字
        g2d.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_LCD_HRGB); // VALUE_TEXT_ANTIALIAS_ON 改为 VALUE_TEXT_ANTIALIAS_LCD_HRGB
        ...
        g2d.drawString(words, wordsX + 5, wordsY + 5);
        // Draw border
        g2d.setColor(borderColor);
        g2d.drawString(words, wordsX - 1, wordsY - 1);
        g2d.drawString(words, wordsX + 1, wordsY + 1);
        g2d.drawString(words, wordsX - 1, wordsY + 1);
        g2d.drawString(words, wordsX + 1, wordsY - 1);
    ...
    public static void main(String[] args) {
        String background = "http://localhost:9999/static/img/games/17/lolm0.png";
        // 统一字体 格式
        ...
        try {
            ...
            // 画字：nickName
            PosterUtil.drawWordsTheme(bufferedImage, "QQ:", false, wordsFont, 18, 30, 88, 1000, 230);
            // 画字：rawInfoMood:为您诚挚推荐生豆信息
            PosterUtil.drawWordsTheme(bufferedImage, "英雄数量:", false, wordsFont, 18, 390, 40, 1000, 230);
            // 画字：title

            PosterUtil.drawWordsTheme(bufferedImage, "皮肤数量:", true, wordsFont, 18, 665, 40, 552, 230);
            // 画字：provider
            PosterUtil.drawWordsTheme(bufferedImage, "游戏区服:", false, wordsFont, 18, 390, 88, 552, 230);
            // 画字：remark
            PosterUtil.drawWordsTheme(bufferedImage, "可二次:", false, wordsFont, 18, 665, 88, 552, 230);
